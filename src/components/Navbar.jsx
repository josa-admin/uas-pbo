...
export default function Navbar() {
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-6 shrink-0 shadow-sm">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        {isBarangKeluar ? (
          <div className="flex items-center gap-2 font-bold text-slate-800">
            <div className="flex items-center justify-center p-1 text-emerald-600">
              <LogOut className="h-5 w-5 rotate-180 text-emerald-600" />
            </div>
            <span className="text-base font-semibold">Barang Keluar</span>
          </div>
        ) : (
          <div className="relative max-w-md w-full md:block hidden">
            ...
            <input
              type="text"
              placeholder="Cari di Barang Masuk..."
      ...
      {/* Right Section: Alerts, Config, & Profile */}
